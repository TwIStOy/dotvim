...
- **[Lua Plugin Quick Reference](reference/lua-plugins.md)** — Adding plugins, colorschemes, language configs, LSP server configs, keymaps, and vim.pack
- **[Nixvim (Nix Build)](reference/nixvim.md)** — Parallel nixvim config: file structure, plugins, keymaps, lazy loading, LSP, custom plugins, Lua↔Nix conversion
