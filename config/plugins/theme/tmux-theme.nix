{...}: {
  ...
  # Drive 'background' from that when $TMUX is set; the active colorscheme
  # then follows via Neovim's native colorscheme reload on 'background'
  # change. Outside tmux, Neovim's native OSC 11 detection is used.
  extraConfigLuaPost = ''
