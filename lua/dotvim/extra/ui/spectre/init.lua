--------------------
--- The module is borrow from
--- https://github.com/mobily/.nvim/blob/main/lua/pickers/spectre/init.lua
--------------------

local engine = require("dotvim.extra.ui.spectre.engine")
local n = require("nui-components")
local search_tree = require("dotvim.extra.ui.spectre.search_tree").search_tree
---@type dotvim.utils
local Utils = require("dotvim.utils")

---@class dotvim.extra.ui.spectre
local M = {}
...
function M.toggle()
  ...
  local subscription = signal:observe(function(prev, curr)
    local diff = vim
      .iter({ "search_query", "is_case_insensitive_checked", "search_paths" })
      :any(function(key)
    ...
    n.rows(
      n.columns(
        ...
        n.text_input {
          ...
          max_lines = 1,
          border_label = "Search",
          on_change = Utils.fn.throttle(400, function(value)
