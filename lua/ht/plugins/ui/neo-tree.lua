...
return {
  ...
  opts = function()
    local get_icon = require("ht.conf.icons").get_icon
    return {
      ...
      source_selector = {
        ...
        sources = {
          {
            source = "filesystem",
            display_name = get_icon("FolderClosed", 1) .. "File",
          },
          {
            source = "buffers",
            display_name = get_icon("DefaultFile", 1) .. "Bufs",
          },
          {
            source = "git_status",
            display_name = get_icon("Git", 1) .. "Git",
          },
          {
            source = "diagnostics",
