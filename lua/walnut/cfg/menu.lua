...
function setup_menu_items()
  ...
  vcall('quickui#menu#install', {
    '&File', {
      {
        '&Open...', [[lua require('ht.actions.file').OpenProjectRoot()]],
  ...
  vcall('quickui#menu#install', {
    '&View', {
      ...
      {
        '&Buffers\t<F4>', [[call quickui#tools#list_buffer('e')]],
        'list buffers'
  ...
  -- Help
  vcall('quickui#menu#install', {'&Help', {}, 10000})
end
